insert into tax_category (category_Id,name,value) values(101,'Category A',10);
insert into tax_category (category_Id,name,value) values(102,'Category B',20);
insert into tax_category (category_Id,name,value) values(103,'Category C',0);
