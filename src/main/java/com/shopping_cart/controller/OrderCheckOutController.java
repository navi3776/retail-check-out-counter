...
import com.shopping_cart.service.CreateOrderService;
...
public class OrderCheckOutController {
    ...
    @ResponseBody
    public BillDetails checkOutOrder(@RequestBody CheckOutOrderDetails orderDetails) {
        logger.info(String.format(" Entering OrderCheckOutController for the current order with order details [%s]",orderDetails));

        BillDetails billDetails = createOrderService.createOrder(orderDetails);
